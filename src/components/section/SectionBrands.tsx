...
// Components (local)
import FormBrands from '@/components/singles/Form/FormBrands';

/*---------- Static Data ----------*/

// Name
const name = 'SectionBrands';

/*---------- Template ----------*/

// Types
export type SectionBrandsProps = {
	className?: string;
};

// Default component
export default function SectionBrands(props: SectionBrandsProps) {
	/*----- Props -----*/
